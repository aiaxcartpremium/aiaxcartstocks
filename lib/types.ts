export type Database = {
  public: {
    Tables: {
      ...
      accounts: {
        Row: {
          id: number; service: string; email: string; password: string; profile: string | null; pin: string | null;
          capital: number; price: number; status: 'available'|'sold'; date_added: string; sold_by: string | null; sold_at: string | null;
        };
        Insert: {
    ...
    Views: {
      account_sales: {
        Row: { id: number; service: string; price: number; capital: number; gross_profit: number; commission_rate: number; commission: number; sold_by: string | null; sold_at: string | null; }
      };
      sales_per_admin: {
