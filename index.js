...
const dbConfig = {
    host: process.env.DB_HOST || 'tjwxdjaybeoekefougzt.supabase.co',
...
const authenticateToken = async (req, res, next) => {
    ...
    try {
        const decoded = jwt.verify(token, process.env.JWT_SECRET || 'stock-management-2024-your-custom-secret-key-here');
...
app.post('/api/auth/login', async (req, res) => {
    try {
        ...
        const token = jwt.sign(
            ...
            process.env.JWT_SECRET || 'stock-management-2024-your-custom-secret-key-here',
            { expiresIn: '24h' }
        );
